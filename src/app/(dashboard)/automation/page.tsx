...
import { Zap, PlusCircle, ToggleLeft, ToggleRight, Trash2 } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="cs-card flex h-40 flex-col items-center justify-center gap-3 text-[rgba(26,26,26,0.45)]">
          ...
          <p className="text-sm">No automation rules yet — add your first!</p>
        </div>
      ) : (
        <div className="space-y-3">
          {rules.map((r) => (
            <div key={r.id} className="cs-card flex items-start gap-4 p-5">
              <div
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <button
                  ...
                  className="text-[rgba(26,26,26,0.3)] hover:text-[#8E0E00]"
                >
          ...
          <div className="cs-card w-full max-w-lg space-y-4 p-6">
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <button
                ...
                disabled={saving}
              >
                {saving && <Spinner size="sm" />} Create Rule
              </button>
            </div>
          </div>
        </div>
